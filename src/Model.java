...
//        System.out.println("Building Step 1");
        ...
        edgeCoords = new int[basedPolygon.getPolygonPoint().size()];
        for (int i = 0; i < basedPolygon.getPolygonPoint().size(); i++) {
            int index = findIndex(basedPolygon.getPolygonPoint().get(i));
            edgeCoords[i] = index;
        }
